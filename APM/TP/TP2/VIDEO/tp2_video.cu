		...
		if(cpt_frame > 800)
		{
			...
			for(i=0; i<height; i++)
			{
				for(j=0; j<width; j++)
				{
					...
					frame1[i*line_size+3*j+2] = 255-((frame1[i*line_size+3*j+2]));
					frame1[i*line_size+3*j+1] = 255-((frame1[i*line_size+3*j+1]));
					frame1[i*line_size+3*j+0] = 255-((frame1[i*line_size+3*j+0]));
